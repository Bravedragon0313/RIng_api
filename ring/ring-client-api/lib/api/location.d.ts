...
export declare class Location {
    ...
    hasHubs: boolean;
    hasAlarmBaseStation: boolean;
    constructor(locationDetails: UserLocation, cameras: RingCamera[], options: {
        hasHubs: boolean;
        hasAlarmBaseStation: boolean;
        locationModePollingSeconds?: number;
    ...
    get name(): string;
    createConnection(): Promise<SocketIOClient.Socket>;
    ...
    sendCommandToSecurityPanel(commandType: string, data?: {}): Promise<void>;
    ...
    getDevices(): RingDevice[] | Promise<RingDevice[]>;
